...
For guidance on bookmarking a system or set of files, read bookmarks://skill/add-to-system or bookmarks://skill/add-to-files.`,
  ...
  },
  {
    ...
    description: 'Diagnose what happened to an anchor\'s code. Returns structured diagnosis: shifted (line moved), exact_match, fuzzy_match, signature_changed (same function/method, refactored declaration — repair at detail.newLine), inlined (a deleted construct\'s body was substituted at a call site — see detail.inlinedAt), merged (a deleted construct\'s body was combined into another method/function — repair at detail.mergedInto), or no_match with full diff. Lines are 1-based.',
    inputSchema: {
      type: 'object',
      properties: {
